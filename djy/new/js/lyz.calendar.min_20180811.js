...
jQuery.fn.extend({
    calendar: function(c) {
        ...
        q = today.getDate(),
        k = "";
        k += "<div id='" + c.controlId + "'class='calendar'><s class='tips'></s>";
        k += "  <div class='calMain'>";
        ...
        function() {
            if ($("#" + c.controlId + ":hidden").length != 0) {
				...
				$("s.tips").css("left","130px");
				if(d>100){d=d-357;$("s.tips").css("left","480px");}
		
                b = b.y + Number(n.attr("clientTop")) + Number(n.attr("clientHeight"))-1+30;
                a.css({
                    top: b + "px",
                    left: d + "px"
                });
